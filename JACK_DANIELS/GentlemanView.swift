...
class GentlemanView: UIView {
    ...
    lazy var descriptionLabel: UILabel = {
        let view = UILabel()
        view.text = "Just like Jack Daniel’s Tennessee Whiskey and Jack Daniel’s Single Barrel, Gentleman Jack is charcoal mellowed before going into the barrel."
        view.textColor = .white
    ...
    lazy var bottleImageView: UIImageView = {
        let view = UIImageView(image: .gentelmanJack)
        return view
    }()
    ...
    lazy var pageControlView: UIPageControl = {
        ...
        view.pointOneView.backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        view.pointTwoView.backgroundColor = #colorLiteral(red: 0.396032095, green: 0.3961050212, blue: 0.3960274756, alpha: 1)
        view.pointThreeView.backgroundColor = #colorLiteral(red: 0.396032095, green: 0.3961050212, blue: 0.3960274756, alpha: 1)
        return view
    }()
